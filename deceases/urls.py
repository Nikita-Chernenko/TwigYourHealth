...
urlpatterns = [
    ...
    path('doctor-create-update-decease/<int:patient_decease_id>/', doctor_create_update_decease,
         name='doctor-create-update-decease'),
    ...
    path('detail/<int:decease_id>/', decease_detail, name='decease-detail'),
